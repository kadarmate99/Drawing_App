...
namespace Drawing_App_v01.Presenter.DrawingStates
{
    ...
    public class RectangleDrawingState : ShapeDrawingStateBase
    {
        ...
        public override void HandleMouseDown(MainWindowPresenter presenter, DrawingModel model, int x, int y)
        {
            ...
            {
                IDrawingCommand drawCommand = new DrawRectangleCommand(_drawingSettings.DrawingColor, _startPoint, _drawingSettings.DrawingLineWidth);
        ...
        public override void TemporaryDraw(Graphics g)
        {
            ...
            {
                ShapeRectangle rectangle = new ShapeRectangle(_drawingSettings.DrawingColor, _startPoint, _currentPoint, _drawingSettings.DrawingLineWidth);
                rectangle.Draw(g);
            }
        }
    }
