...
namespace Drawing_App_v01.Presenter.DrawingStates
{
    ...
    {
        public RhombusDrawingState(Color currentColor) : base(currentColor) { }
        ...
        public override void HandleMouseDown(MainWindowPresenter presenter, DrawingModel model, int x, int y)
        {
            ...
            {
                IDrawingCommand drawCommand = new DrawRhombusCommand(_currentColor, _startPoint);
        ...
        public override void TemporaryDraw(Graphics g)
        {
            ...
            {
                ShapeRhombus rhombus = new ShapeRhombus(_currentColor, _startPoint, _currentPoint);
                rhombus.Draw(g);
            }
        }
    }
